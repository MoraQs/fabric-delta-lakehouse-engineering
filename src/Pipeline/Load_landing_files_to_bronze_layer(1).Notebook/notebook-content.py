...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "2510f19a-93ad-4514-82dd-c50668727e24",
# META       "default_lakehouse_name": "AdventureWorks_LS",
# META       "default_lakehouse_workspace_id": "becc9b21-7306-4bcb-a97c-42e63477797a",
# META       "known_lakehouses": [
# META         {
# META           "id": "2510f19a-93ad-4514-82dd-c50668727e24"
# META         }
# META       ]
# META     }
# META   }
...
# BRONZE_SCHEMA = "bronze" # As defined in your script
# # Assuming table_files dictionary is populated from the DISCOVERY STAGE

# if 'table_files' in locals() and table_files:
#     print("🗑️ Starting deletion of Bronze tables...")
    
#     for table_name in table_files.keys():
#         # Clean the name the same way it was written
#         table_clean_name = table_name.replace("/", "_").lower()
#         full_table_name = f"{BRONZE_SCHEMA}.{table_clean_name}"
        
#         # Construct the SQL DROP TABLE statement
#         sql_command = f"DROP TABLE IF EXISTS {full_table_name}"
...
#     print("\n🏁 Bronze table deletion completed.")
# else:
#     print("ℹ️ No table names found in 'table_files' to delete.")

# # You may also want to drop the audit table if it was created during testing
